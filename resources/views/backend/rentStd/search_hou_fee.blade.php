        ...
        <div id="basic_fee">
            <table class="listTable" style="white-space:nowrap;">
                <tr>
                    ...
                    <th class="freqMode">
                        <a href="#" class="sort" name="freqMode" hidefocus>机房基准价格(元/月)(不含税)</a>
                    </th>
                </tr>
                @if(isset($hou_fees))
                    @foreach($hou_fees as $hou_fee)
                        <tr>
                            <!--<td>
                                <a href="{{url('backend/rentStd/hou_fee_update/'.$hou_fee->seq.'/'.$filter['region'].'/'.$filter['fee_type'])}}">修改</a>
                            </td>-->
                            <td>{{$hou_fee->tower_type}}</td>
                            <td>{{$hou_fee->product_type}}</td>
                            <td>{{$hou_fee->is_new_tower}}</td>
                            <td>{{$hou_fee->fee_hou}}</td>
                        </tr>
                    @endforeach
                @endif
