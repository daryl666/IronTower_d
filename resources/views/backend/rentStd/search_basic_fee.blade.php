            ...
            <form id="listForm" method="post" target="_self" action="{{url('backend/rentStd/fee_std_search')}}">
                ...
                <div class="listBar">
                    ...
                    <select name="fee_type">
                        <option selected="selected">基准价格</option>
                        <option>场地费</option>
                        <option>电力引入费</option>
                        <option>共享折扣</option>
                    </select>
            ...
            <table class="listTable" style="white-space:nowrap;">
                <tr>
                   <!-- <th class="freqMode">
                    ...
                    <th class="freqMode">
                        <a href="#" class="sort" name="freqMode" hidefocus>系统挂高(米)</a>
                    </th>
                    <th class="freqMode">
                    ...
                    <th class="freqMode">
                        <a href="#" class="sort" name="freqMode" hidefocus>基准价格(元/天)(不含税)</a>
                    </th>
                </tr>
                @if(isset($basic_fees))
                    @foreach($basic_fees as $basic_fee)
                        <tr>
                            <!--<td>
                                <a href="{{url('backend/rentStd/basic_fee_update/'.$basic_fee->seq.'/'.$filter['region'].'/'.$filter['fee_type'])}}">修改</a>
                            </td>-->
                            <td>{{$basic_fee->tower_type}}</td>
                            <td>{{$basic_fee->sys_height}}</td>
                            <td>{{$basic_fee->product_type}}</td>
                            <td>{{$basic_fee->is_new_tower}}</td>
                            <td>{{$basic_fee->fee_basic}}</td>
                        </tr>
                    @endforeach
                @endif
