        ...
        <div class="input managerInfo" style="margin-top: 25px;">
            <div class="bar">
                <div style="float:left;">
                    人工填写&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="{{url('backend/siteInfo/addNewPage'.'/'.$region)}}">新建站</a>
                    <a href="{{url('backend/siteInfo/addOldPage'.'/'.$region)}}" style="color: #FF5809">存量站</a>
                </div>
            ...
            <table class="inputTable tabContent">
                ...
                {{--<tr>--}}
                    ...
                    {{--<td>--}}
                        ...
                        {{--<select name="elecIntroType" id="elecIntroType">--}}
                        {{--<option selected="selected">请选择...</option>--}}
                        {{--<option>380V</option>--}}
                        {{--<option>220V</option>--}}
                        {{--</select>--}}
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="userType" value="原产权" checked="checked">原产权
