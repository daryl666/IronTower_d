        ...
        <div id="basic_fee">
            <table class="listTable" style="white-space:nowrap;">
                <tr>
                    ...
                    <th class="freqMode">
                        <a href="#" class="sort" name="freqMode" hidefocus>铁塔基准价格(元/月)(不含税)</a>
                    </th>
                </tr>
                @if(isset($tow_fees))
                    @foreach($tow_fees as $tow_fee)
                        <tr>
                            {{--<td>--}}
                                {{--<a href="{{url('backend/rentStd/tow_fee_update/'.$tow_fee->seq.'/'.$filter['region'].'/'.$filter['fee_type'])}}">修改</a>--}}
                            {{--</td>--}}
                            <td>{{$tow_fee->tower_type}}</td>
                            <td>{{$tow_fee->sys_height}}</td>
                            <td>{{$tow_fee->is_new_tower}}</td>
                            <td>{{$tow_fee->fee_tow}}</td>
                        </tr>
                    @endforeach
                @endif
