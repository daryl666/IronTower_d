    ...
    <div class="list">
            ...
            <form id="listForm" method="post" target="_self" action="{{url('backend/rentStd/fee_std_search')}}">
                ...
                <div class="listBar">
                    ...
                    <select name="fee_type">
                        ...
                        <option>维护费</option>
                        <option>场地费</option>
                        <option selected="selected">电力引入费</option>
                        <option>共享折扣</option>
                    </select>
        ...
        <div id="elec_introduced_fee">
            <table class="listTable" style="white-space:nowrap;">
                ...
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>引电类型</a>
                </th>
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>电力引入费(元/天)(不含税)</a>
                </th>

                </tr>
                @if(isset($elec_introduced_fees))
                    @foreach($elec_introduced_fees as $elec_introduced_fee)
                        <tr>
                            <!--<td>
                                <a href="{{url('backend/rentStd/elec_introduced_fee_update/'.$elec_introduced_fee->seq)}}">修改</a>
                            </td>-->
                            <td>{{$elec_introduced_fee->region_name}}</td>
                            <td>{{$elec_introduced_fee->elec_introduced_type}}</td>
                            <td>{{$elec_introduced_fee->fee_import}}</td>
                        </tr>
                    @endforeach
                @endif
...
@section('script_footer')
    ...
    <script type="text/javascript">
        ...
        function exportStd() {
            ...
            listForm.action = "{{url('backend/rentStd/exportElecImportFee')}}";
            listForm.submit();
        }
