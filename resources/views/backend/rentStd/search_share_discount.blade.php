    ...
    <div class="list">
            ...
            <form id="listForm" method="post" target="_self" action="{{url('backend/rentStd/fee_std_search')}}">
                ...
                <div class="listBar">
                    ...
                    <select name="fee_type">
                        ...
                        <option>场地费</option>
                        <option>电力引入费</option>
                        <option selected="selected">共享折扣</option>
                    </select>
        ...
        <div id="share_discount">
            <table class="listTable" style="white-space:nowrap;">
                ...
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>共享类型</a>
                </th>
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>用户类型</a>
                </th>
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>是否存在新增共享</a>
                </th>
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>基准价格折扣</a>
                </th>
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>场地费折扣</a>
                </th>
                <th class="freqMode">
                    <a href="#" class="sort" name="freqMode" hidefocus>电力引入费折扣</a>
                </th>

                </tr>
                @if(isset($share_discounts))
                    @foreach($share_discounts as $share_discount)
                        <tr>
                            <!--<td><a href="{{url('backend/rentStd/share_discount_update/'.$share_discount->seq)}}">修改</a>
                            </td>-->
                            <td>{{$share_discount->is_new_tower}}</td>
                            <td>{{$share_discount->share_type}}</td>
                            <td>{{$share_discount->user_type}}</td>
                            <td>{{$share_discount->is_newly_added}}</td>
                            <td>{{$share_discount->discount_basic}}</td>
                            <td>{{$share_discount->discount_site}}</td>
                            <td>{{$share_discount->discount_import}}</td>
                        </tr>
                    @endforeach
                @endif
...
@section('script_footer')
    ...
    <script type="text/javascript">
        ...
        function exportStd() {
            ...
            listForm.action = "{{url('backend/rentStd/exportDiscount')}}";
            listForm.submit();
        }
